...
• شرط: a ≠ 0`
    ...
    // تابع نمایش فرمول بر اساس موضوع
    ...
    // نمایش یا مخفی کردن انتخابگر شکل هندسی
    ...
    // تولید ورودی‌ها بر اساس topic و در صورت نیاز shape
    function updateInputs() {
        ...
        // برای درصد: تغییر ورودی بر اساس نوع درصد
        if (topic === 'percent') {
        ...
        // برای توان: نمایش یا مخفی کردن فیلد نما
        if (topic === 'power') {
            ...
            if (topic === 'geometry') {
                ...
                switch(shape) {
                    ...
                    case 'circle':
                        ...
                        result = `مساحت: ${(Math.PI*r*r).toFixed(2)} cm² | محیط: ${(2*Math.PI*r).toFixed(2)} cm`;
                        break;
                    case 'triangle':
                    ...
                    case 'sphere':
                        ...
                        result = `حجم کره: ${vol.toFixed(2)} cm³`;
                        break;
                }
            }
            else if (topic === 'percent') {
                ...
                if (op === 'decimal') {
                    ...
                    // ساده‌سازی کسر (با بزرگترین مقسوم علیه مشترک)
                    function gcd(a,b) {
